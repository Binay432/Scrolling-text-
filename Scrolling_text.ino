...
//Columns
int clockPin1 = 9; //Arduino pin connected to Clock Pin 11 of 74HC595
int latchPin1 = 8; //Arduino pin connected to Latch Pin 12 of 74HC595
...
int latchPin2 = 11; //Arduino pin connected to Latch Pin 12 of 74HC595
int dataPin2 = 10;  //Arduino pin connected to Data Pin 14 of 74HC595
